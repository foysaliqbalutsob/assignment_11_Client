...
// const HeroBanner = () => {
//   return (
//     <section className="relative bg-gray-50   dark:bg-slate-900 overflow-hidden transition-colors duration-300">
...
const HeroBanner = () => {
  return (
    // 'dark:bg-gray-900' এবং 'dark:text-white' যোগ করা হয়েছে
    <section className="relative bg-gray-50 dark:bg-slate-900 overflow-hidden transition-colors duration-300">
      <div className="max-w-7xl mx-auto px-6 lg:px-8 flex flex-col lg:flex-row items-center py-16 lg:py-24">
        ...
        <div className="flex-1 text-center lg:text-left">
          <motion.h1 
            // 'dark:text-white' নিশ্চিত করে যে ডার্ক মোডে লেখা সাদা হবে
          ...
          <motion.p
            // 'dark:text-gray-300' যোগ করা হয়েছে
        ...
        <motion.div 
          ...
          transition={{ duration: 1 }}
        >
          {/* 'dark:border-gray-700' যোগ করতে পারেন যদি বর্ডার থাকে */}
          <img src={heroImg} alt="Corporate Banner" className="w-full rounded-xl shadow-lg border dark:border-gray-800"/>
        </motion.div>
      </div>
    </section>
  );
