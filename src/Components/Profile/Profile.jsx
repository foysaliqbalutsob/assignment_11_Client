...
//   axiosSecure.get(`/employee/companies/${user.email}`)
...
//       // 2️⃣ Update backend
//       await axiosSecure.patch(`/users/${encodeURIComponent(user.email)}`, updatedInfo);
...
//     <label className="label">
//       <span className="label-text font-semibold">Affiliated Companies</span>
//     </label>
