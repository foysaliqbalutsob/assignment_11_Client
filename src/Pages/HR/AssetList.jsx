...
//               <p>
//                 <b>Company:</b> {asset.companyName}
//               </p>
//               <p>
//                 <b>Quantity:</b> {asset.productQuantity}
//               </p>
...
//                   <img src={asset.productImage} className="w-10 h-10 rounded" />
//                   <div>
  ...
  const onSubmit = async (data) => {
    try {
      ...
      if (data.productImage && data.productImage[0]) {
        ...
        data.productImage = photoRes.data.data.url; // new image URL
      } else {
        ...
        <div className="modal-box">
          ...
          {selectedAsset && (
            <img
              ...
              alt="Current Asset"
              className="w-24 h-24 rounded mb-3 mx-auto"
            />
          )}
